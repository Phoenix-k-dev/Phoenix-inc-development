(() => {
  ...
  const svg={
    ...
    tiktok:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M14.7 3c.4 2.2 1.7 3.6 3.9 4v3.1a8.1 8.1 0 0 1-3.8-1.1v6.1a6.1 6.1 0 1 1-5.3-6.1v3.2a3 3 0 1 0 2.2 2.9V3h3Z"/></svg>',
  ...
  const makeLink=(kind,url,label)=>`<a class="phx-social phx-social-${kind}" ${url?`href="${url}" target="_blank" rel="noopener"`:'aria-disabled="true"'} aria-label="${label}" title="${url?label:label+' — bientôt'}">${svg[kind]}</a>`;
